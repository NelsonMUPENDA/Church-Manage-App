...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('church_management', '0015_event_closure_alert_fields'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='visitor_aggregate', to='church_management.event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logistics_consumptions', to='church_management.event')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='event_consumptions', to='church_management.logisticsitem')),
