...
def forwards_create_linked_events(apps, schema_editor):
    Event = apps.get_model('church_management', 'Event')
    EvangelismActivity = apps.get_model('church_management', 'EvangelismActivity')
    TrainingEvent = apps.get_model('church_management', 'TrainingEvent')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('church_management', '0019_marriage_identity_fields'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='evangelism_activity', to='church_management.event'),
        ),
        migrations.AddField(
            model_name='trainingevent',
            name='published_event',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='training_event', to='church_management.event'),
        ),
