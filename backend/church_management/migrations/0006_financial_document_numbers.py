...
def forwards(apps, schema_editor):
    FinancialTransaction = apps.get_model('church_management', 'FinancialTransaction')
    FinancialDocumentSequence = apps.get_model('church_management', 'FinancialDocumentSequence')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('church_management', '0005_create_default_admin'),
    ]
