...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('church_management', '0016_event_visitors_and_logistics_consumption'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='baptism_event', to='church_management.event')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bride', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='marriages_as_bride', to='church_management.member')),
                ...
                ('groom', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='marriages_as_groom', to='church_management.member')),
                ('published_event', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='marriage_record', to='church_management.event')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('baptism_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidates', to='church_management.baptismevent')),
            ],
        ),
    ]
