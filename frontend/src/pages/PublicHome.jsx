  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-semibold text-indigo-800 dark:text-indigo-200">Bienvenue dans notre famille</span>
              </motion.div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-6">
                <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Consolation</span>
                <br />et Paix Divine
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <Link to="/events" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-2xl transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5">
                  <CalendarDaysIcon className="h-5 w-5" />
                  Nos Programmes
                  <ArrowRightIcon className="h-5 w-5" />
                </Link>
                <Link to="/about" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white dark:bg-slate-800 text-gray-900 dark:text-white font-semibold rounded-2xl border-2 border-gray-200 dark:border-white/10 hover:border-indigo-300 dark:hover:border-indigo-500/50 transition-all shadow-lg hover:shadow-xl">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6">
                  <div className="flex gap-6 text-white">
                    <div><div className="text-2xl font-bold">500+</div><div className="text-xs opacity-80">Membres</div></div>
                    <div><div className="text-2xl font-bold">15</div><div className="text-xs opacity-80">Années</div></div>
                    <div><div className="text-2xl font-bold">12</div><div className="text-xs opacity-80">Ministères</div></div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <span className="text-indigo-600 dark:text-indigo-400 font-semibold text-sm uppercase tracking-wider">Nos Horaires</span>
            <h2 className="mt-2 text-3xl font-bold text-gray-900 dark:text-white">Venez nous rejoindre</h2>
            <p className="mt-4 text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">Nous nous réunissons tout au long de la semaine pour célébrer, étudier et prier ensemble.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {CHURCH_INFO.serviceTimes.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">{service.day}</h3>
                <p className="text-indigo-600 dark:text-indigo-400 font-semibold text-sm mb-2">{service.time}</p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <span className="text-indigo-600 dark:text-indigo-400 font-semibold text-sm uppercase tracking-wider">Nos Ministères</span>
            <h2 className="mt-2 text-3xl font-bold text-gray-900 dark:text-white">Engagez-vous dans un ministère</h2>
            <p className="mt-4 text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">Il y a une place pour chacun dans le corps de Christ. Découvrez comment vous pouvez servir.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {MINISTRIES.map((ministry, index) => (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-slate-400 text-sm leading-relaxed">{ministry.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <span className="text-indigo-200 font-semibold text-sm uppercase tracking-wider">À Venir</span>
            <h2 className="mt-2 text-3xl font-bold">Prochains événements</h2>
            <p className="mt-4 text-indigo-100 max-w-2xl mx-auto">Ne manquez pas nos moments importants de communion et de célébration.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {UPCOMING_EVENTS.map((event, index) => (
              ...
              >
                ...
                <Link to="/events" className="inline-flex items-center gap-2 text-sm font-semibold text-white hover:text-indigo-200 transition-colors">
                  En savoir plus<ChevronRightIcon className="h-4 w-4" />
                </Link>
              </motion.div>
            ))}
          </div>
          ...
          <div className="text-center mt-10">
            <Link to="/events" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-indigo-700 font-semibold rounded-2xl hover:bg-indigo-50 transition-colors shadow-lg">
              Voir tous les événements<ArrowRightIcon className="h-5 w-5" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl">
            ...
            <p className="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto">Que vous soyez nouveau dans la foi ou à la recherche d'une communauté chrétienne, vous êtes les bienvenus chez Consolation et Paix Divine.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/announcements" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/20 text-white font-semibold rounded-2xl hover:bg-white/30 transition-colors border border-white/30">
                <BookOpenIcon className="h-5 w-5" />Lire nos publications
              </Link>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a href={CHURCH_INFO.socials.facebook} className="w-10 h-10 rounded-full bg-white/10 hover:bg-indigo-600 flex items-center justify-center transition-colors" aria-label="Facebook"><GlobeAltIcon className="h-5 w-5" /></a>
                <a href={CHURCH_INFO.socials.youtube} className="w-10 h-10 rounded-full bg-white/10 hover:bg-red-600 flex items-center justify-center transition-colors" aria-label="YouTube"><PlayIcon className="h-5 w-5" /></a>
                <a href={CHURCH_INFO.socials.instagram} className="w-10 h-10 rounded-full bg-white/10 hover:bg-pink-600 flex items-center justify-center transition-colors" aria-label="Instagram"><HeartIcon className="h-5 w-5" /></a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link to="/about" className="hover:text-white transition-colors flex items-center gap-2"><ChevronRightIcon className="h-4 w-4" />À Propos de l'Église</Link></li>
                ...
                <li><Link to="/login" className="hover:text-white transition-colors flex items-center gap-2"><ChevronRightIcon className="h-4 w-4" />Espace Membres</Link></li>
              </ul>
            </div>
